...
print("
    <nav class='nav nav-tabs bg-dark fixed-top'>
      ...
      <li class='nav-item'>
        <a class='nav-link active' href='../views/coordinador.php'>Coordinador</a>        
      </li>
      <li class='nav-item'>
    ...
    <form action='../controllers/controladorCoordinador.php' method='POST'>
      <input  class='btn bg-dark text-primary'  type='submit' id='Add' name='Add' value='Add'/>
    </form>
...
?>
 <body>
      <script type = "text/javascript">
        function validar(id){
          var dato = confirm("¿Esta seguro de actualizar el coordinador" + id+"?");
          if(!dato){
