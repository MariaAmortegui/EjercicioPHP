...
<div class="container-fluid ps-md-0">
    <div class="row g-0">
        <div class="d-none d-md-flex col-md-4 col-lg-6 bg-image">
            <img src="https://img.freepik.com/foto-gratis/hombre-escribiendo-correo-electronico_53876-137663.jpg?w=740&t=st=1666639902~exp=1666640502~hmac=2f45e347e789c0e64cc93829734d0f39c716af75294c7f66d1cd9fd144210495"class="d-block w-100" alt="..."/>
        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto">
                                <h1 class="login-heading mb-4 text-bold text-primary">AGREGAR ALUMNO</h1>
                                    <form action="../../controllers/controladorAlumno.php" method="post">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" type="text" name="newTel" id="newTel" required/>
                                        ...
                                        <div class="d-grid">
                                            <input class="btn btn-lg btn-dark btn-login text-uppercase fw-bold mb-2" type="submit" name="btnnewAlumno" id="btnnewAlumno" value="Enviar"/>
